    ...
    <AnimatedBackground variant="video">
      <div className="flex min-h-screen items-center justify-center relative">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          {/* Hero Badge */}
          <Badge variant="secondary" className="mb-8 bg-white/10 backdrop-blur-md border-white/20 text-white shadow-lg">
          ...
          <p className="text-xl leading-8 text-white/90 sm:text-2xl mb-12 max-w-3xl mx-auto">
            Create amazing artwork using official brand assets. Build your portfolio. Get recognized. All completely legal.
          </p>

          {/* Key Features */}
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <Badge variant="outline" className="bg-gradient-purple/20 backdrop-blur-md border-white/30 text-white px-4 py-2">
              Creator Economy Revolution
            </Badge>
            <Badge variant="outline" className="bg-gradient-pink/20 backdrop-blur-md border-white/30 text-white px-4 py-2">
              Web3 Ready
            </Badge>
            <Badge variant="outline" className="bg-gradient-blue/20 backdrop-blur-md border-white/30 text-white px-4 py-2">
              Enterprise Scale
            </Badge>
          </div>
