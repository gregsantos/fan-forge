    ...
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="sm" asChild>
          <Link href="/brand/submissions" className="flex items-center gap-2">
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" size="sm" asChild>
                    <a href={submission.artworkUrl} target="_blank" rel="noopener noreferrer">
              ...
              <CardContent>
                ...
                {submission.reviewedBy && submission.reviewedAt && (
                  <div className="mt-4 pt-4 border-t text-sm text-muted-foreground">
                    Reviewed by {submission.reviewedBy.displayName} on {formatDate(submission.reviewedAt)}
                  </div>
                )}
              </CardContent>
            </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium">{submission.creator?.displayName || 'Unknown Creator'}</p>
              ...
              {submission.creator?.bio && (
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{submission.creator.bio}</p>
                </div>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-3">
              ...
              {submission.ipKit && (
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{submission.ipKit.name}</p>
                </div>
              )}
            </CardContent>
          </Card>
