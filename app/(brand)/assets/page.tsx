...
export default function AssetsPage() {
  ...
  // Note: We're now fetching ALL brand assets across all IP kits
  // No longer filtering by a specific IP Kit ID
        ...
        <TabsContent value='grid' className='space-y-6'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Browse and manage your uploaded assets. Click on any asset to
                view details.
              </CardDescription>
            </CardHeader>
            <CardContent>
