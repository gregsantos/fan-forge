      ...
      <div className='mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8'>
            ...
            <div className='flex items-center justify-between mb-4 sm:mb-6'>
              <div>
                ...
                <p className='text-sm sm:text-base text-muted-foreground'>
                  Curated opportunities from top brands
                </p>
              </div>
            </div>
                      ...
                      <div className='flex items-start justify-between'>
                        <div className='flex-1'>
                          <div className='flex items-center gap-2 mb-3'>
                            ...
                            <Badge
                              className={cn(
                                "text-xs capitalize font-medium shadow-sm",
                    ...
                    <CardContent className='flex-1 flex flex-col space-y-4 pt-0'>
                      ...
                      <div className='flex items-center gap-2 text-sm'>
                        ...
                        <span className='font-medium'>
                          {campaign.deadline
                            ? formatDate(new Date(campaign.deadline))
                            : "No deadline"}
                        </span>
                      </div>
        ...
        {loading ? (
          <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 max-w-7xl mx-auto'>
            {Array.from({length: 6}).map((_, i) => (
              <Card
                key={i}
                className='animate-pulse w-full h-full flex flex-col'
              >
                <CardHeader>
                  <div className='flex items-start justify-between'>
        ...
        {!loading && campaigns.length > 0 && (
          <div className='mt-6 sm:mt-8 text-center text-sm text-muted-foreground'>
            Showing page {currentPage} of {totalPages} ({campaigns.length}{" "}
            campaigns)
          </div>
        )}
      </div>
