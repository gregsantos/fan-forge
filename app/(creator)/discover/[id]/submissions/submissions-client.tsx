...
import {ArrowLeft, Heart, Award, Users, Search} from "lucide-react"
...
export function CampaignSubmissionsClient({
  campaign,
  initialData,
}: CampaignSubmissionsClientProps) {
        ...
        {submissions.length > 0 ? (
          <>
            ...
            <div className='mb-4 text-sm text-muted-foreground'>
              Showing {submissions.length} approved submission
                  ...
                  <CardContent className='p-4 space-y-3'>
                    <div className='space-y-1'>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        By{" "}
                        {submission.creator?.displayName || "Anonymous Creator"}
                      </p>
                    </div>

                    <div className='flex items-center gap-2 flex-wrap'>
                      <Badge className='bg-gradient-to-r from-green-500 to-emerald-500 text-white border-transparent font-medium shadow-sm text-xs'>
